...
#ifdef __IPHONE_4_0
#define VERTEX_SHADER_PRG			( char * )"GouraudShadeVertex.glsl"
#define FRAGMENT_SHADER_PRG			( char * )"GouraudShadeFragment.glsl"
#else
...
ObjLoader::~ObjLoader()
{
	...
	if ( program = ProgramManagerObj->Program( ( char * )"SGouraudShader" ) )
	{
