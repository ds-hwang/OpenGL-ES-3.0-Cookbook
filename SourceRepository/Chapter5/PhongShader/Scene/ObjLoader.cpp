...
#ifdef __IPHONE_4_0
#define VERTEX_SHADER_PRG			( char * )"PhongShadeVertex.glsl"
#define FRAGMENT_SHADER_PRG			( char * )"PhongShadeFragment.glsl"
#else
...
void ObjLoader::InitModel()
{
	...
	if (! ( program = ProgramManagerObj->Program( ( char * )"PhongShader" ) ) )
	{
		program = ProgramManagerObj->ProgramInit( ( char * )"PhongShader" );
