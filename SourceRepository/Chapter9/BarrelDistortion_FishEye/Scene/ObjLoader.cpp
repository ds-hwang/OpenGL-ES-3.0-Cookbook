...
void ObjLoader::InitModel()
{
    ...
    char MaterialSpecular = GetUniform(program,(char*)"MaterialSpecular");
    char MaterialDiffuse  = GetUniform(program,(char*)"MaterialDiffuse");
    char ShininessFactor  = GetUniform(program,(char*)"ShininessFactor");
    
    // Get Light property uniform variables
    char LightAmbient     = GetUniform(program,(char*)"LightAmbient");
    char LightSpecular    = GetUniform(program,(char*)"LightSpecular");
    char LightDiffuse     = GetUniform(program,(char*)"LightDiffuse");
    char LightPosition     = GetUniform(program, (char*)"LightPosition");
...
void ObjLoader::Render()
{
    ...
    TransformObj->TransformScale(1.8, 1.8, 1.8);
