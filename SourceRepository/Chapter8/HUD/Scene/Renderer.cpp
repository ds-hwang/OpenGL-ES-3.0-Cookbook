...
void Renderer::createModels()
{
...
#endif
    addModel( new Font(strcat(fname,"ae_Nagham.ttf"), 25, this, Arabic) );
    ...
    strcpy( fname, "/sdcard/GLPIFramework/Font/" );
#endif
    addModel( new Font(strcat(fname,"Roboto-Black.ttf"), 25, this, English) );
    ...
    strcpy( fname, "/sdcard/GLPIFramework/Font/" );
#endif
    addModel( new Font(strcat(fname,"DroidSansThai.ttf"), 25, this, Thai) );
    ...
    strcpy( fname, "/sdcard/GLPIFramework/Font/" );
#endif
    addModel( new Font(strcat(fname,"Uni Ila.Sundaram-03.ttf"), 25, this, Tamil) );
    ...
    strcpy( fname, "/sdcard/GLPIFramework/Font/" );
#endif
    addModel( new Font(strcat(fname,"AnmolUni.ttf"), 25, this, Punjabi) );
