...
{
	RenderMemData.isPrespective = true;
}
...
void Renderer::createModels()
{
...
#endif
    addModel( new Font(strcat(fname,"ae_Nagham.ttf"), 50, this, Arabic) );
    ...
    strcpy( fname, "/sdcard/GLPIFramework/Font/" );
#endif
    addModel( new Font(strcat(fname,"Roboto-Black.ttf"), 50, this, English) );
    ...
    strcpy( fname, "/sdcard/GLPIFramework/Font/" );
#endif
    addModel( new Font(strcat(fname,"DroidSansThai.ttf"), 50, this, Thai) );
    ...
    strcpy( fname, "/sdcard/GLPIFramework/Font/" );
#endif
    addModel( new Font(strcat(fname,"Uni Ila.Sundaram-03.ttf"), 50, this, Tamil) );
    ...
    strcpy( fname, "/sdcard/GLPIFramework/Font/" );
#endif
    addModel( new Font(strcat(fname,"AnmolUni.ttf"), 50, this, Punjabi) );
...
void Renderer::setUpProjection()
{
	...
	if ( considerAspectRatio ){
		...
		if ( RenderMemData.isPrespective ){
    ...
    int w = screenWidthPixel();
    int h = screenHeightPixel();
...
/*!
	Create and Initializies all models.
