...
#ifdef __IPHONE_4_0
#define VERTEX_SHADER_PRG			( char * )"RotateCircleVertex.glsl"
#define FRAGMENT_SHADER_PRG			( char * )"RotateCircleFragment.glsl"
#else
#define VERTEX_SHADER_PRG			( char * )"shader/RotateCircleVertex.glsl"
#define FRAGMENT_SHADER_PRG			( char * )"shader/RotateCircleFragment.glsl"
#endif
...
void ObjLoader::InitModel()
{
    ...
    radianAngle   = ProgramManagerObj->ProgramGetUniformLocation(program, (char*)"RadianAngle");
