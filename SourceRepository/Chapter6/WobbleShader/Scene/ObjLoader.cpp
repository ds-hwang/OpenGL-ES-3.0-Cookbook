...
#ifdef __IPHONE_4_0
#define VERTEX_SHADER_PRG			( char * )"WobbleVertex.glsl"
#define FRAGMENT_SHADER_PRG			( char * )"WobbleFragment.glsl"
#else
...
char ModelNames[][STRING_LENGTH]= {"Torus.obj", "Sphere.obj", "Monkey.obj", "IsoSphere.obj","SubDividedPlane.obj"};
/*!
