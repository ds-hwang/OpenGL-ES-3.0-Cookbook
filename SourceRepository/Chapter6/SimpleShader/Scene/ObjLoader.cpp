...
#ifdef __IPHONE_4_0
#define VERTEX_SHADER_PRG			( char * )"SimpleVertexShader.glsl"
#define FRAGMENT_SHADER_PRG			( char * )"SimpleFragmentShader.glsl"
#else
...
char ModelNames[][STRING_LENGTH]= { "Sphere.obj", "Torus.obj", "Plane.obj", "Monkey.obj", "IsoSphere.obj" };
/*!
