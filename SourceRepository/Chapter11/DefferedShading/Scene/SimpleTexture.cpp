...
SimpleTexture::~SimpleTexture()
{
	...
	if ( program = ProgramManagerObj->Program( ( char * )"defferedShade" ) )
	{
...
void SimpleTexture::InitModel()
{
	...
	if (! ( program = ProgramManagerObj->Program( ( char * )"defferedShade" ) ) )
	{
		program = ProgramManagerObj->ProgramInit( ( char * )"defferedShade" );
    ...
    POS_TEX     = ProgramManagerObj->ProgramGetUniformLocation( program, (char *) "PosTexture" );
    NORMAL_TEX  = ProgramManagerObj->ProgramGetUniformLocation( program, (char *) "NormalTexture" );
    COLOR_TEX   = ProgramManagerObj->ProgramGetUniformLocation( program, (char *) "ColorTexture" );
    glUniform1i(COLOR_TEX, 0);
    glUniform1i(POS_TEX, 1);
    glUniform1i(NORMAL_TEX, 2);
